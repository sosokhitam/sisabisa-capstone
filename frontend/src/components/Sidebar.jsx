...
export default function Sidebar({ isOpen = false, onClose }) {
  ...
  const navItems = [
    ...
    { label: 'Rekomendasi',  path: '/recommendations',  icon: ChefHat         },
    { label: 'Favorit Resep',path: '/favorites',        icon: Bookmark        },
  ];
    ...
    <>
      ...
      >
        ...
        <div className="h-[4.5rem] flex items-center justify-between px-5 border-b border-green-100/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 font-bold mt-0.5 uppercase tracking-widest">Smart Food Inventory</p>
            </div>
          </div>
        ...
        <nav className="flex-1 px-3 py-5 space-y-1 overflow-y-auto">
          <p className="text-[10px] font-extrabold uppercase tracking-widest text-slate-400/80 px-3 mb-4">Navigasi</p>
                ...
                >
                  {active && (
                    <motion.div
                      ...
                      className="absolute left-0 top-2.5 bottom-2.5 w-[3px] rounded-r-full bg-gradient-to-b from-green-700 to-lime-500"
                    />
                  )}
                  ...
                  {active && (
                    <div className="ml-auto w-1.5 h-1.5 rounded-full bg-green-500 shadow-sm shadow-green-500/50" />
                  )}
                </Link>
              </motion.div>
            );
        ...
        <div className="p-3 border-t border-green-100/50 space-y-2">
          {user && (
            <div className="flex items-center gap-3 px-3 py-3 rounded-2xl bg-green-50/60 border border-green-100/40">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-green-700 to-green-600 text-white flex items-center justify-center text-sm font-extrabold flex-shrink-0 shadow-md shadow-green-700/20">
